	...
	var Adver = Backbone.View.extend({
		...
		initialize: function() {
			this.$('a[data-toggle=popover]').popover({
				...
				title: i18n.t('pad:donate.title'),//"If you feel that is useful, donate to help keep development going. <a href='http://pad.haroopress.com/page.html?f=grow-up-donate' id='donate-link'>Donate</a>"
				animation: false
			});
