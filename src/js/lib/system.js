;(function() {
  ...
  global.SHORTCUTS = {
    ...
    /* markdown */
    'insert-header1': 'defmod-1',
    'insert-header2': 'defmod-2',
    'insert-header3': 'defmod-3',
    'insert-header4': 'defmod-4',
    'insert-header5': 'defmod-5',
    'insert-header6': 'defmod-6',
    'insert-bold': 'defmod-',
    'insert-italic': 'defmod-',
    'insert-link': 'defmod-',
    'insert-underline': 'defmod-',
    'insert-inline-code': 'defmod-',
    'insert-embed': 'defmod-',
    'insert-toc': 'defmod-',
    'insert-strike': 'defmod-',
    'insert-highlight': 'defmod-',
    'insert-ordered-list': 'defmod-',
    'insert-unordered-list': 'defmod-',
    'insert-image': 'defmod-',
    'insert-math': 'defmod-',
    'insert-blockquote': 'defmod-',
    'insert-section-break': 'defmod-',
    'insert-page-break': 'defmod-',
    'insert-sentence-break': 'defmod-',
