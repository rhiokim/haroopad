var _glo = {
	getEmailAdvertisementHTML: function() {
		return ''
			...
			+ '	<span>'
			+ '   <img src="http://pad.haroopress.com/assets/images/logo-small.png" align="absmiddle" width="42" height="42" style="margin-right: 10px;"/>'
			+ '   AD : The next document processor <a href="http://pad.haroopress.com/" target="_blank">Haroopad</a>, '
	...
	getEmailAdvertisementMD: function() {
		return ''
			+ '\n----------------------  \n'
			+ '\t> **AD**  \n'
			+ '\t> This e-mail is mail that is easily created in Haroopad.  \n'
