...
_yuitest_coverage["build/graphics-svg-default/graphics-svg-default.js"].code=["YUI.add('graphics-svg-default', function (Y, NAME) {","","Y.Graphic = Y.SVGGraphic;","Y.Shape = Y.SVGShape;","Y.Circle = Y.SVGCircle;","Y.Rect = Y.SVGRect;","Y.Ellipse = Y.SVGEllipse;","Y.Path = Y.SVGPath;","Y.Drawing = Y.SVGDrawing;","","","}, '3.9.0pr1');"];
