...
var _wrapCallBack = function(anim, fn, callback) {
    _yuitest_coverfunc("build/transition/transition.js", "_wrapCallBack", 536);
_yuitest_coverline("build/transition/transition.js", 537);
return function() {
        _yuitest_coverfunc("build/transition/transition.js", "(anonymous 8)", 537);
...
Y.Node.prototype.hide = function(name, config, callback) {
    _yuitest_coverfunc("build/transition/transition.js", "hide", 547);
...
Y.NodeList.prototype.toggleView = function(name, on, callback) {
    _yuitest_coverfunc("build/transition/transition.js", "toggleView", 635);
...
Y.mix(Transition.fx, {
    ...
    sizeIn: {
        height: function(node) {
            _yuitest_coverfunc("build/transition/transition.js", "height", 668);
_yuitest_coverline("build/transition/transition.js", 669);
return node.get('scrollHeight') + 'px';
        },
        width: function(node) {
            _yuitest_coverfunc("build/transition/transition.js", "width", 671);
_yuitest_coverline("build/transition/transition.js", 672);
return node.get('scrollWidth') + 'px';
        ...
        on: {
            start: function() {
                _yuitest_coverfunc("build/transition/transition.js", "start", 678);
...
this._transitionOverflow = overflow;
                ...
                _yuitest_coverfunc("build/transition/transition.js", "end", 686);
...
_yuitest_coverline("build/transition/transition.js", 696);
Y.mix(Transition.toggles, {
    size: ['sizeOut', 'sizeIn'],
    fade: ['fadeOut', 'fadeIn']
});

_yuitest_coverline("build/transition/transition.js", 701);
Transition.DEFAULT_TOGGLE = 'fade';



}, '3.9.0pr1', {"requires": ["node-style"]});
