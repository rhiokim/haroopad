...
_yuitest_coverage["build/json-parse/json-parse.js"].code=["YUI.add('json-parse', function (Y, NAME) {","","var _JSON = Y.config.global.JSON;","","Y.namespace('JSON').parse = function () {","    return _JSON.parse.apply(_JSON, arguments);","};","","}, '3.9.0pr1', {\"requires\": [\"yui-base\"]});"];
