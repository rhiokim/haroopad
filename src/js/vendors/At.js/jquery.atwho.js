  ...
  (function(factory) {
    ...
    Controller = (function() {
      ...
      Controller.prototype.content = function() {
        var cur = nw.editor.getCursor();
        var token = nw.editor.getTokenAt(cur);
        return token.string.substr(0, Math.min(token.end, cur.ch));
    ...
    View = (function() {
      ...
      View.prototype.hide = function(time) {
        var callback,
          _this = this;
        //add real hide callback by rhiokim
        if (this.visible()) {
          this.context.$inputor.trigger('hide.atwho');
        }
